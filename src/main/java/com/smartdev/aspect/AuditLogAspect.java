...
import com.smartdev.annotations.Auditable;
import com.smartdev.entity.AuditLogEntity;
import com.smartdev.repository.AuditLogRepository;
...
public class AuditLogAspect {
    ...
    @Pointcut("execution(* com.smartdev.smartdev.repository.*.save(..)) || execution(* com.smartdev.smartdev.repository.*.delete(..))")
